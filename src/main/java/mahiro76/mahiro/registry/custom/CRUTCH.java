...
public class CRUTCH extends ToolItem implements Vanishable {
    private final float attackDamage;
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public CRUTCH(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Item.Settings settings) {
